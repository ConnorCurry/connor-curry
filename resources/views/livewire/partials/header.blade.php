<div class="w-full relative z-5">
    <div class="w-full bg-primary flex justify-between relative">
        <a href="/" class="hover:translate-x-1 transition"><h1 class="text-2xl md:text-3xl font-bold text-white pt-2 px-3 md:px-4 md:pt-4">Connor Curry</h1></a>
