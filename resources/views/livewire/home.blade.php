<div>
    <div class="relative">
        ...
        <div class="absolute top-0 z-2 left-0 w-full h-full bg-black/50 flex flex-col justify-center align-center">
            <div class="mx-auto max-w-7xl w-full p-3 overflow-hidden">
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center">
                ...
                <p class="mb-4">
                    ...
                    <a target="_blank" href="https://evolutionmarketing.com"
                        class="text-indigo-400 cursor-pointer hover:-translate-y-0.5 hover:text-primary transition inline-block">Evolution
                        Marketing</a>
                    as a Senior Frontend Web Developer, I help businesses both small and large build marketing and SEO
                    friendly websites to broaden their reach.
                    I manage a team of frontend developers in the maintenance of 600+ active sites built on the <a
                        ...
                        class="text-indigo-400 cursor-pointer hover:-translate-y-0.5 hover:text-primary transition inline-block">CMS Max</a>
                    platform.
                </p>
                <p class="mb-4">
                    Outside of Evolution Marketing, I enjoy working on side projects in several frameworks,
                    languages and environments. I also spend my free time making music with friends and
                    family,
                    running, snowboarding and playing games.
                </p>
